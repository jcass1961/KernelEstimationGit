...
\item We changed the text as follows
		\begin{quote}
	In particular, several measures have been proposed to reflect the closeness between \DIFdelbegin \DIFdel{two distribution functions.} \DIFdelend \DIFaddbegin \DIFadd{the models that describe samples.}\DIFaddend
		\end{quote}
