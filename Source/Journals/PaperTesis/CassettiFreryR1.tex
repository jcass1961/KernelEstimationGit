...
\begin{document}
	...
	\begin{figure}[hbt]
		\centering
		\subfigure[\label{SesgoSinContL=3}$\widehat{\text{Bias}}$]{\includegraphics[width=0.9\linewidth]{../../../Figures/PaperTesis/GraficoSesgoMVyGAyLNyLC_L=3SinCont_BarrasErroryPercentil.eps}}
	...
	\begin{figure}[hbt]
		\centering
		\subfigure[\label{SesgoSinContL=8}$\widehat{\text{Bias}}$]{\includegraphics[width=0.9\linewidth]{../../../Figures/PaperTesis/GraficoSesgoMVyGAyLNyLC_L=8SinCont_BarrasErroryPercentil.eps}}
...
\begin{table}[htbp]
	...
	\begin{tabular}{cc c*3{S[table-format=3.2]}  c*3{S[table-format=3.2]} c*3{S[table-format=3.2]}}
		\toprule
		\multirow{2}{5mm}{$\alpha$} & \multirow{2}{5mm}{$n$} & \multicolumn{4}{c}{Skewness} & \multicolumn{4}{c}{Kurtosis} \\
		\cmidrule(r){3-6} \cmidrule(r){7-10} \cmidrule(r){11-14}
		&     & \multicolumn{1}{c}{$\widehat{\alpha}_{\text{{ML}}}$} & \multicolumn{1}{c}{\centering $\widehat{\alpha}_{\Gamma}$} & \multicolumn{1}{c}{$\widehat{\alpha}_{\text{{LN}}}$}  & \multicolumn{1}{c}{$\widehat{\alpha}_{\text{{LC}}}$}  &  
...
\begin{table}[htbp]
	...
	\begin{tabular}{cc c*3{S[table-format=3.2]}}
		\toprule
		\multirow{2}{5mm}{$\alpha$} & \multirow{2}{5mm}{$n$} & \multicolumn{4}{c}{Variance} \\
		\cmidrule(r){3-6}  
		&     & \multicolumn{1}{c}{$\widehat{\alpha}_{\text{{ML}}}$} & \multicolumn{1}{c}{\centering $\widehat{\alpha}_{\Gamma}$} & \multicolumn{1}{c}{$\widehat{\alpha}_{\text{{LN}}}$}  & \multicolumn{1}{c}{$\widehat{\alpha}_{\text{{LC}}}$}  \\
		\cmidrule(r){1-6} 
		\multirow{6}[2]{*}{-1.5} 
...
\end{figure}
%Prog:AsymptoticDensityNoCont_n500.R	
