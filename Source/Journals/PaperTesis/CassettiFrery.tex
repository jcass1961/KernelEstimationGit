...
\title{Improvements to the Minimum Distance Estimator for the Texture Parameter of the $\mathcal{G}^0$ model
	%\thanks{Grants or other notes about the article that should go on the front page should be
...
\institute{Julia Cassetti \at
	...
	\and
	Alejandro C. Frery Orgambide\at
	Instituto de Computa\c c\~ao, Universidade Federal de Alagoas, and the Key Lab of Intelligent Perception and Image Understanding of the Ministry of Education, Xidian University, Xi'an, China\\
	Av. Lourival Melo Mota, s/n, 57072-900 Macei\'o -- AL, Brazil\\
	Tel.: (55 82) 3214-1401
	\email{acfrery@gmail.com}
}
...
%%% ACF Hasta acá 20 de mayo 2020, 8:20 AM
...
%	\begin{figure}[H]
%		\centering
%		\subfigure[L=3]{\includegraphics[width=.45\linewidth]{../../../Figures/PaperTesis/DensidadGI0L3}}
%		\subfigure[L=8]{\includegraphics[width=.45\linewidth]{../../../Figures/PaperTesis/DensidadGI0L8}}
...
%	$\widehat{\widetilde{k}}_1 =   -\log \frac{L}{-\widehat\alpha_{\text{\tiny{LC}}}-1} + \Psi^0(L) - \Psi^0(-\widehat\alpha_{\text{\tiny{LC}}})$, that is, 
...
\begin{figure}[htb]
	\centering
	\subfigure[$L=3$]{\includegraphics[width=.75\linewidth]{../../../Figures/PaperTesis/DensidadGI0L3}}
	\subfigure[$L=8$]{\includegraphics[width=.75\linewidth]{../../../Figures/PaperTesis/DensidadGI0L8}}
	\caption{\label{densidades} $\mathcal{G}^0(\alpha,\gamma^*,L)$ densities}
\end{figure}
...
\begin{table}[hbt]        
	...
	\begin{tabular}{cc S[table-format=0.1]S[table-format=0.1]S[table-format=0.1] S[table-format=0.1] @{\hskip 8mm} S[table-format=0.2]S[table-format=0.1]S[table-format=0.1]S[table-format=0.1]}                                    
		\toprule                                    
		\multirow{4 }{3mm}{$\alpha$} &\multirow{4 }{*}{ n  } & \multicolumn{4}{c}{\multirow{2 }{*}{MISE}} & \multicolumn{4}{c}{\centering \% }\\
	 &                          &                &               &         &     &   \multicolumn{4}{c}{non convergence cases}\\
		...
		&           & \mc{$\Gamma$} & \mc{LN}       & \mc{IG}     & \mc{$\text{IG}_{\text{\tiny{E}}}$}    & \mc{$\widehat{\alpha}_{\Gamma}$} & \mc{$\widehat{\alpha}_{\text{\tiny{LN}}}$}    & \mc{$\widehat{\alpha}_{\text{\tiny{IG}}}$} & \mc{$\widehat{\alpha}_{\text{\tiny{IG}}_{\text{\tiny{E}}}}$}\\
		\midrule                
		\multirow{5 }{3mm}{$-1.5$} 
...
Therefore we choose $\Gamma$ and LN kernels to estimate the underlying density function.

The following analysis was performed through a Monte Carlo experiment, which consists of $500$ independent replications for each of several parameter values: $L\in\{3,8\}$ to consider multilook case,
$\alpha\in\{-1.5, -3, -5, -8\}$ to represent different levels of texture and $n\in\{9, 25,49, 81,121,500\}$ to consider different scenarios of window sizes, and a large sample situation.
...
\begin{figure}[htb]
	\centering
	\subfigure[\label{SesgoSinContL=3}$\widehat{\text{Sesgo}}$]{\includegraphics[width=\linewidth]{../../../Figures/PaperTesis/GraficoSesgoMVyGAyLNyLC_L=3SinCont_BarrasErroryPercentil}}
	\subfigure[\label{ECMSinContL=3}$\widehat{\text{MSE}}$]{\includegraphics[width=\linewidth3]{../../../Figures/PaperTesis/GraficoECMMVyGAyLNyLC_L=3SinCont_BarrasErroryPercentil}}
...
\begin{figure}[htb]
	\centering
	\subfigure[\label{SesgoSinContL=8}$\widehat{\text{Sesgo}}$]{\includegraphics[width=\linewidth]{../../../Figures/PaperTesis/GraficoSesgoMVyGAyLNyLC_L=8SinCont_BarrasErroryPercentil}}
	\subfigure[\label{ECMSinContL=8}$\widehat{\text{MSE}}$]{\includegraphics[width=\linewidth]{../../../Figures/PaperTesis/GraficoECMMVyGAyLNyLC_L=8SinCont_BarrasErroryPercentil}}
...
\begin{figure}[htb]
	\centering
	\subfigure[\label{InflL3alfa-1.5n25}$\widehat{\alpha}=-1.5$]{\includegraphics[width=.48\linewidth]{../../../Figures/PaperTesis/CurvaInfluenciaAlfa-1punto5L3n25}}
	\subfigure[\label{InflL3alfa-3n25}$\widehat{\alpha}=-3$]{\includegraphics[width=.48\linewidth]{../../../Figures/PaperTesis/CurvaInfluenciaAlfa-3L3n25}}
...
\begin{figure}[htb]
	\centering
	\subfigure[\label{InflL3alfa-5n25}$\widehat{\alpha}=-5$]{\includegraphics[width=.48\linewidth]{../../../Figures/PaperTesis/CurvaInfluenciaAlfa-5L3n25}}
	\subfigure[\label{InflL3alfa-8n25}$\widehat{\alpha}=-8$]{\includegraphics[width=.48\linewidth]{../../../Figures/PaperTesis/CurvaInfluenciaAlfa-8L3n25}}
...
\begin{figure}[htb]
	\centering
	\subfigure[\label{InflL8alfa-1.5n25}$\widehat{\alpha}=-1.5$]{\includegraphics[width=.48\linewidth]{../../../Figures/PaperTesis/CurvaInfluenciaAlfa-1punto5L8n25}}
	\subfigure[\label{InflL8alfa-3n25}$\widehat{\alpha}=-3$]{\includegraphics[width=.48\linewidth]{../../../Figures/PaperTesis/CurvaInfluenciaAlfa-3L8n25}}
...
\begin{figure}[htb]
	\centering
	\subfigure[\label{InflL8alfa-5n25}$\widehat{\alpha}=-5$]{\includegraphics[width=.48\linewidth]{../../../Figures/PaperTesis/CurvaInfluenciaAlfa-5L8n25}}
	\subfigure[\label{InflL8alfa-8n25}$\widehat{\alpha}=-8$]{\includegraphics[width=.48\linewidth]{../../../Figures/PaperTesis/CurvaInfluenciaAlfa-8L8n25}}
...
\begin{figure}[htb]
	\centering
	\subfigure[\label{SesgoConContL=3}$\widehat{\text{Bias}}$]{\includegraphics[width=.8\linewidth]{../../../Figures/PaperTesis/GraficoSesgoMVyGAyLNyLC_L=3Cont_BarrasErrorypercentil}}
	\subfigure[\label{ECMConContL=3}$\widehat{\text{MSE}}$]{\includegraphics[width=.8\linewidth]{../../../Figures/PaperTesis/GraficoECMMVyGAyLNyLC_L=3Cont_BarrasErrorypercentil}}
	\caption{\label{SesgoyECMConContL=3}\small Bias and MSE for contaminated data,  $\epsilon=0.05$ and $ L=3$.}
\end{figure}

\begin{figure}[htb]
	\centering
	\subfigure[\label{SesgoConContL=8}$\widehat{\text{Bias}}$]{\includegraphics[width=.8\linewidth]{../../../Figures/PaperTesis/GraficoSesgoMVyGAyLNyLC_L=8Cont_BarrasErrorypercentil}}
	\subfigure[\label{ECMConContL=8}$\widehat{\text{MSE}}$]{\includegraphics[width=.8\linewidth]{../../../Figures/PaperTesis/GraficoECMMVyGAyLNyLC_L=8Cont_BarrasErrorypercentil}}
