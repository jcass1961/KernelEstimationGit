...
\begin{document}
	...
	\begin{abstract}
		Speckled images, such as SAR imagery, are well described by the $\mathcal G^0$ distributions family because it possess the ability to characterize areas with different degrees of texture. 
		...
		This paper proposes and compares estimation methods of the texture parameter in intensity format. For the multilook case, the proposal is to estimate this parameter by minimizing the triangular distance between $\mathcal G^0$ density and an estimate of the underlying density function using Gamma and Lognormal kernels.	The properties of these estimators are assessed with analytic results and simulation. Actual images were used to evaluate the performance of our propose.
...
%	\begin{figure}[H]
%		\centering
%		\subfigure[L=3]{\includegraphics[width=.45\linewidth]{../../../Figures/PaperTesis/DensidadGI0L3.eps}}
%		\subfigure[L=8]{\includegraphics[width=.45\linewidth]{../../../Figures/PaperTesis/DensidadGI0L8.eps}}
...
%	
	...
	\begin{figure}[htb]
		\centering
		\subfigure[\label{SesgoSinContL=3}$\widehat{\text{Sesgo}}$]{\includegraphics[width=.8\linewidth]{../../../Figures/PaperTesis/GraficoSesgoMVyGAyLNyLC_L=3SinCont_BarrasErroryPercentil.eps}}
		\subfigure[\label{ECMSinContL=3}$\widehat{\text{MSE}}$]{\includegraphics[width=.8\linewidth3]{../../../Figures/PaperTesis/GraficoECMMVyGAyLNyLC_L=3SinCont_BarrasErroryPercentil.eps}}
	...
	\begin{figure}[htb]
		\centering
		\subfigure[\label{SesgoSinContL=8}$\widehat{\text{Sesgo}}$]{\includegraphics[width=.8\linewidth]{../../../Figures/PaperTesis/GraficoSesgoMVyGAyLNyLC_L=8SinCont_BarrasErroryPercentil.eps}}
		\subfigure[\label{ECMSinContL=8}$\widehat{\text{MSE}}$]{\includegraphics[width=.8\linewidth]{../../../Figures/PaperTesis/GraficoECMMVyGAyLNyLC_L=8SinCont_BarrasErroryPercentil.eps}}
...
%	
	\begin{figure}[htb]
		\centering
		%\subfigure[\label{MuestraLooks}Samples used to estimate ENL]{\includegraphics[width=0.48\linewidth]{../../../Figures/PaperTesis/MuestrasEstimNumLooks.eps}}
...
%	\vfill
%	
%	\begin{IEEEbiography}[{\includegraphics[width=1in]{../../../Images/Fotos/ACFrery_gray.eps}}]{Alejandro C.\ Frery} (S'92--SM'03)
