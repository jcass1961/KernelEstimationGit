...
\begin{figure}[H]
	...
	\caption{\label{SeñalDispersada}Dispersión de la señal emitida por un radar SAR.} %Fuente Canada Centre for Remote Sensing~\cite{ccrs2001}.}
\end{figure} 
%
...
PONER FIGURA TICO luz coherente, el dibujo donde la superficie esta separada una distancia d
