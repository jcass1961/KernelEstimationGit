...
\begin{table}[H]
	...
	\begin{tabular}{c*9{c}}
	\toprule
	\multirow{2 }{*} {Color} & \multirow{2 }{*}{n} & \multirow{2 }{*}{$\widehat\alpha_{\text{\tiny{MV}}}$} & \multirow{2 }{*}{$\widehat\alpha_{\text{\tiny{T}}}$} & \multirow{2 }{*}{$\widehat\alpha_{\text{\tiny{Mom12}}}$} & \multirow{2 }{*}{$\widehat\alpha_{\text{\tiny{LC}}}$} & \small Tiempo  &  \small Tiempo & \small Tiempo &  \small Tiempo  \\
	&      &                        &                           &                                 &                                &  \small MV &  \small DT &   \small Mom12 &  LC \\
	\midrule
...
El experimento Monte Carlo que se implementó es como el descripto en~\ref{ExperimentoMontecarlo}, en esta oportunidad se realizaron $500$ replicaciones independientes para cada uno de los valores de los parámetros: 
