...
With the aim to study the performance of the selected entropy estimators in terms of  SAR image classification, we divided the analysis into simulated and actual images. 
...
\subfigure[\label{fig:AccuracyL2}Accuracy]{\includegraphics[width=.8\linewidth]{../../../Figures/CISS2021/Accuracy_L2.pdf}}
