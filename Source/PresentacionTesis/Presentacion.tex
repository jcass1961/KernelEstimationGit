...
\begin{document}
	...
	\begin{frame}
		...
		\begin{itemize}
			\item \citet{Frery97} presentaron la familia de distribuciones $\mathcal{G}^0$ para datos dados tanto en formato amplitud como en intensidad, generando la familia de distribuciones $\mathcal{G}_A^0$ y $\mathcal{G}_I^0$ respectivamente.
			\bigskip
	...
	\begin{frame}
		...
		\item Interpretación del parámetro $\alpha$ de la distribución $\mathcal{G}_I^0$ en términos de la textura de la zona observada.  
			...
			\pause \item En lo siguiente vamos a emplear el valor $\gamma^*$ tal que $E(Z)=1$, 
			\begin{tikzpicture}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\frac{1}{n} \sum_{i=1}^n\log (z_i) =   -\log \left(\frac{L}{-\widehat{\alpha}_{\text{\tiny{LC}}}-1}\right) + \Psi^0(L) + \Psi^0(-\alpha),
			\end{align*}
			donde $\Psi^0(\cdot)$ es la función digamma.
		\end{itemize}
	\end{frame}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\medskip
			\item \citet{Scaillet2004} indica que el \alert{sesgo} en el borde de los núcleos $\Gamma$, IG y RIG el sesgo en el borde es \alert{$O(b)$}.
			\medskip
			\item \citet{Libnegue2013} indica que el \alert{sesgo} correspondiente al núcleo LN es \alert{$O(b^2)$}.
		\end{itemize}
	\end{frame}
	...
	\begin{frame}
		\frametitle{Selección de distancia}
		...
		\begin{itemize}
			...
			\medskip
			\pause \item Tamaño de muestra: $n=\{9, 25,49, 81,121,1000\}$. 
			\medskip
			\pause \item Textura: $\alpha=\{-1.5, -3, -5, -8\}$ para modelar diferentes texturas.
			\medskip
			\pause \item Looks: $L=\{3,8\}$, para modelar varios niveles de procesamiento.
			...
			\medskip
			\pause \item Estimamos $\widehat{f}$ utilizando histogramas.
		\end{itemize}
	\end{frame}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\medskip
			\pause \item el mínimo se encontró recorriendo un rango de valores de $\alpha \in [-10,-1)$.
			\medskip
			\pause \item Estimamos
			\medskip
			\begin{itemize}
				\pause \item $\widehat{B}(\widehat\alpha) = \overline{\widehat\alpha}- \alpha$.
				\medskip
				\pause \item $\widehat{\operatorname{\text{ECM}}}=({1000})^{-1}{\sum_{i=1}^{1000}{(\widehat{\alpha}_i-\alpha)^2}}$,
			\end{itemize}
			\medskip
	...
	\begin{frame}
		\frametitle{Incorporamos núcleos}
		...
		\begin{itemize}
			...
			\medskip
			\pause \item Comparamos los estimadores basados en la distancia Triangular ($\widehat{\alpha}_{\text{\tiny{DT}}}$) con: $\widehat{\alpha}_{\text{\tiny{MV}}}$, $\widehat{\alpha}_{\text{\tiny{Mom12}}}$, $\widehat{\alpha}_{\text{\tiny{LC}}}$.
			\medskip
			\pause \item Evaluamos el impacto de la contaminación en la estimación de $\alpha$.
			\medskip
			\pause \item Tomamos el ancho de banda $b=\dfrac{1}{2\sqrt{n}}$.
			\medskip
			\pause \item Consideramos $\alpha \in [-20,-1)$ pues...
		\end{itemize}
	...
	\begin{frame}
		...
		\only<1>{
			\begin{figure}
				\includegraphics[width=0.40\linewidth]{../../Figures/Tesis/Presentacion/VariasMuestrasMagenta.pdf}
				%\caption{\label{Caso1L3}\small Datos contaminados: Caso $1$, $\epsilon=0.01$ y $L=3$.}
			\end{figure}
		...
		\only<2>{
			\begin{figure}
				\includegraphics[width=0.40\linewidth]{../../Figures/Tesis/Presentacion/VariasMuestrasRoja.pdf}
				%\caption{\label{Caso1L3}\small Datos contaminados: Caso $1$, $\epsilon=0.01$ y $L=3$.}
			\end{figure}
		...
		\only<3>{
			\begin{figure}
				\includegraphics[width=0.40\linewidth]{../../Figures/Tesis/Presentacion/VariasMuestrasAzul.pdf}
				%\caption{\label{Caso1L3}\small Datos contaminados: Caso $1$, $\epsilon=0.01$ y $L=3$.}
			\end{figure}
		...
		\only<4>{
			\begin{figure}
				\includegraphics[width=0.40\linewidth]{../../Figures/Tesis/Presentacion/VariasMuestrasVerde.pdf}
				%\caption{\label{Caso1L3}\small Datos contaminados: Caso $1$, $\epsilon=0.01$ y $L=3$.}
			\end{figure}
		...
		\only<5>{
			\begin{figure}
				\includegraphics[width=0.40\linewidth]{../../Figures/Tesis/Presentacion/VariasMuestrasAmarilla.pdf}
				%\caption{\label{Caso1L3}\small Datos contaminados: Caso $1$, $\epsilon=0.01$ y $L=3$.}
			\end{figure}
			\begin{table}
				%\begin{tabular}{c c c c c c}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\medskip
			\item Se mostró que la distancia \alert{triangular} es una buena elección para este problema.
			\medskip
			\item Para el caso \alert{multilook} se mostró que los núcleos \alert{$\Gamma$} y \alert{LN} presentan buenas propiedades medidas por su sesgo, ECM y por porcentaje de casos de no convergencia, especialmente para muestras de pequeño tamaño.
			\medskip
