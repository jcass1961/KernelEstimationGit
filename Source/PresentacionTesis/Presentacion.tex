...
\begin{frame}
	...
	\begin{itemize}
		...
		\medskip
		\item se calcula $\widehat{\alpha_i}= \mathop{\text{arg min}}\limits_{-10 \leq \alpha <-1}d(f_{\mathcal{G}_I^0(\alpha,-\alpha-1,L)},\widehat{f})$ donde $d$ es alguna de las distancias estocásticas consideradas.
		\medskip
