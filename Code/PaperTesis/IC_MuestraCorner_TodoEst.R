...
muestra1.green<-read_delim(nombre1)[,-1]
muestra2.green<-read_delim(nombre2)[,-1]
muestra3.green<-read_delim(nombre3)[,-1]
#muestra4.green<-read_delim(nombre4)[,-1]


muestra.MV.green<-muestra1.green%>%mutate(color=color,metodo=nucleo1,alfa.est=x)%>%select(metodo,color,alfa.est)
muestra.GA.green<-muestra2.green%>%mutate(color=color,metodo=nucleo2,alfa.est=x)%>%select(metodo,color,alfa.est)
muestra.LN.green<-muestra3.green%>%mutate(color=color,metodo=nucleo3,alfa.est=x)%>%select(metodo,color,alfa.est)
#muestra.LC.green<-muestra4.green%>%mutate(color=color,metodo=nucleo4,alfa.est=x)%>%select(metodo,color,alfa.est)

muestra.green<-rbind(muestra.MV.green,muestra.GA.green,muestra.LN.green)
...
muestra.yellow<-rbind(muestra.MV.yellow,muestra.GA.yellow,muestra.LN.yellow,muestra.LN.yellow)
...
muestra<-rbind(muestra.green,muestra.yellow,muestra.red)
head(muestra)
