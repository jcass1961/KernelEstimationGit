...
source("EntropiaFisherGI0_2par.R")
getwd()
```
```{r}
L=2
...
```{r}
m_por_sesgoW<-fread("../../../Data/CISS2021/Figura2.csv")
...
plt1
ggsave(plot=plt1, file="../../../Figures/CISS2021/Grafico_Hest_Sesgo_mW_L=2ConNeg.pdf", width=12, height=12, units="cm")
...
facet_wrap(~alfa, labeller = label_parsed)
plt2
ggsave(plot=plt2, file="../../../Figures/CISS2021/Grafico_Hest_ECM_mW_L=2ConNeg.pdf", width=12, height=12, units="cm")
