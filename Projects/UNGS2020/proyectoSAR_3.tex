...
% ser difíciles de interpretar y analizar debido a la presencia del ruido speckle. Este ruido es inherente al proceso de captura de la imagen y 
...
%%% ACF Esto no es metodología, es Introducción -> Relevancia
...
%%% ACF Esto no es metodología, es Introducción -> Justificativa
...
%%% ACF Esto no es metodología, es Metodología
